...
\begin{tikzpicture}[every node/.style={transform shape}, thick, >=latex, node distance=1cm]
	\node[basic box = blue, header = Teaching Phase] (teaching) {
		\includegraphics[width=\scaling]{teaching}%\\
