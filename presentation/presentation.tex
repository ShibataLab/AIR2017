...
\begin{frame}{Related Works}
	...
	\begin{columns}[t]
		...
		\begin{column}{0.5\textwidth}
			...
			{\scriptsize
				\begin{itemize}
					%\item[\color{green}{\checkmark}] Used Reinforcement learning (RL)
...
%	\begin{exampleblock}{Procedure}
%		\begin{enumerate}
%			\item Each trajectory is computed by calculating the mean.
%			\item The force value is norm of force applied in all three Cartesian directions.
%		\end{enumerate}
%	\end{exampleblock}
%
%	\vskip -1em
...
%			\begin{figure}
%				\includegraphics[width=0.8\textwidth]{failure_scenario_2}
%				\caption{A failure scenario}
%			\end{figure}
%		\end{column}
%
%		\begin{column}{0.5\textwidth}
